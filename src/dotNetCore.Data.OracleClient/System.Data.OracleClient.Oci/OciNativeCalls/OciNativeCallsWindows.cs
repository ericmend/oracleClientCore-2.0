...
{
    internal sealed class OciNativeCallsWindows : IOciNativeCalls
    {
        internal OciNativeCallsWindows() { }
        ...
        private sealed class NativeCalls
        {
            private NativeCalls()
            { }
            public const string KERNEL = "kernel32";
            public const string OCI_DLL = "oci";
            public const int GMEM_ZEROINIT = 0x40;

            [DllImport(KERNEL)]
            public static extern IntPtr GlobalAlloc(int flags, int bytes);
        ...
        {
            return NativeCalls.GlobalAlloc(NativeCalls.GMEM_ZEROINIT, cb);
        }
        #endregion
    }
}